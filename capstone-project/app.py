...
class Request(BaseModel):
    url: str = Field(..., example="https://raw.githubusercontent.com/shall-it/machine-learning-zoomcamp/main/capstone-project/blood-cell-images-for-cancer-detection-prepared/test/myeloblast/MYO_0700.jpg")
